              ...
              <div className='flex items-center p-5'>
                ...
                <div>
                  <p className='text-sm truncate'>
                    <span className='font-bold mr-1'>ivailotoshev </span> 
                    My awesome paint!
                  </p>
                </div>
              </div>
      ...
      <div className='flex justify-center'>
        <div className='flex justify-center items-center'>
          <div className=''>
            ...
            {/* More posts section */}
            <div className='mt-10'>
              <h1 className='text-sm text-gray-500 font-semibold'>More posts from <span className='text-black'>ivailotoshev</span></h1>
            </div>
